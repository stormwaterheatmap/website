...
100-meter gaussian kernel. This resulted in "fuzzy" predictors that could apply across dataset boundaries. These values were then extracted for each monitored watershed.
...
The first step of translating COC equations to the Stormwater Heatmap was to convolve each grid on the base map.  Following convolution of the map, regression equations were applied to each grid box to predict the concentration of contaminants expected for that grid box.  
...
|-------------------------------------|--------------------------|-----------------------------|--------------------------------------------|
|intercept          | 6.523           |6.521                     |6.642                        |6.574                                       |
|rain               |-0.149           |-0.157                    |-0.148                       |-0.156                                      |
|summer             |0.603            |0.675                     |0.606                        |0.667                                       |
|sqrt CO2 road      |0.276            |0.276                     |0.277                        |0.253                                       |
